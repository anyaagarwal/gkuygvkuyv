...
function draw(){
  ...
  if(n(block1)===true){
    ball.velocityY=ball.velocityY*-1-1.7;
    ball.velocityX=ball.velocityX*-1-1.7;
    ball.shapeColor="pink";
}
  
  if(n(block2)===true){
    ball.velocityY=ball.velocityY*-1+1.3;
    ball.velocityX=ball.velocityX*-1+2.3;
    ball.shapeColor="lavender";
}
  
  if(n(block3)===true){
    ball.velocityY=ball.velocityY*-1-2;
  ...
  if(n(block4)===true){
    ...
    ball.velocityX=ball.velocityX*-1+0.4;
